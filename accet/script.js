...
const generateTaskCard = ({id, url, title,  description, number}) => {
    ...
    const saveToLocalStorage = () => {
        localStorage.setItem("ziyadgym", JSON.stringify({ziyad: globalTaskData}));
    }

    const reloadTaskCard = () => {
        const localStorageCopy = JSON.parse(localStorage.getItem("ziyadgym"));
